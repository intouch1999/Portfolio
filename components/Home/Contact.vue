...
<Layout>
    ...
    <div class="container px-6 py-12 mx-auto">
        <div class="text-center group text-blue-500 transition-colors hover:text-yellow-600 duration-300">
            <h1 class="mt-2 text-2xl font-semibold  md:text-3xl">Contact</h1>            
