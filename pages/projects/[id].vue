<template>
  <section
    ...
    <div class="container px-6 py-10 mx-auto text-center">
      <section class="bg-white rounded-2xl shadow-lg p-10" data-aos="zoom-in" data-aos-duration="1000">
        ...
        <div class="container mx-auto">
          <p class="text-left mt-4 text-black text-md sm:text-lg lg:text-xl font-light" data-aos="fade-up"
            data-aos-delay="100">
            {{ project.desc }}
          </p>
        </div>
        ...
        <div class="container mx-auto">
          <h1
            class="text-xl sm:text-2xl lg:text-3xl font-semibold capitalize hover:text-yellow-400 transition-colors duration-300 tracking-wider mt-6"
        ...
        <div class="flex justify-center mt-8">
          <div class="mockup-code bg-primary text-primary-content w-full md:w-2/3 xl:w-1/3 ">
  ...
  Code Languages<span class="inline-block w-2 h-1 bg-black rounded-full blink-animation group-hover:bg-yellow-400"></span>
            ...
            <div class="grid grid-cols-2 md:flex md:flex-row justify-center mt-6" data-aos="fade-up"
              ...
              <div class="flex flex-col items-center m-4 group" v-for="language in project.lang">
                <div class="p-1 bg-white rounded-full">
                  <img :key="language"
                    class="w-5 h-5  m-2 md:transition-transform md:transform md:hover:scale-150 rounded-full"
        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-10 mt-16" data-aos="fade-up"
          data-aos-delay="600">
          <ClientOnly>
            <div v-for="(img, index) in project.img" :key="index"
